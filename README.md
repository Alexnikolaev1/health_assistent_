...
Персональный AI Health Assistant для мессенджера MAX с предиктивным анализом симптомов, дневником метрик, напоминаниями о лекарствах и конструктором привычек.
...
| 🏆 **Челленджи** | 10 000 шагов, без сахара, вода и другие |
| 👨‍⚕️ **Визит к врачу** | Подсказка, к какому специалисту обратиться и что сообщить на приёме (запись — самостоятельно) |
| 📋 **Больничный** | Краткая справка: оформление через поликлинику / Госуслуги |
...
│   │   └── physician-reminder.ts   # Тексты про визит к врачу и больничный
...
| `/appointment` | Подсказка перед визитом к специалисту |
| `/sickleave` | Справка про больничный лист |
